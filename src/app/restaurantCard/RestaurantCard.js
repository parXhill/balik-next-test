...
export default function RestaurantCard({restaurant, dispatch}){
    ...
    function SelectedCard(){
        return( 
        <div onClick={handleClick} id={restaurant.id} className="relative flex-none flex flex-col bg-slate-100 rounded-3xl mx-2 overflow-y-scroll no-scrollbar shadow-xl mb-2 transition-all duration-300 h-[24rem] w-[30rem]">
